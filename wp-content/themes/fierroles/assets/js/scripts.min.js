...
(function() {
    ...
    var a = $(".isotope-container").imagesLoaded(function() {
        a.isotope({
            itemSelector: ".isotope-item"
        });
    });
    $(".nav-project-grid-filters li a").on("click", function(b) {
        b.preventDefault(), $(".nav-project-grid-filters li a").removeClass("active");
        var c = $(this).attr("data-filter");
        a.isotope({
            filter: c
        }), $(this).toggleClass("active");
    });
    var b = $(".isotope-container .isotope-item"), c = (b.length, $(".nav-project-items-mini-grid"));
    $.each(b, function(a, b) {
        var d = "<li class='" + $(b).data("minigrid") + "'><a href='#'></a></li>";
        c.append(d);
    });
    var d = $(".nav-project-items-mini-grid li"), e = $(".projects-grid li");
    $(d).on("mouseover", function() {
        var a = $(this).index(), b = $(e[a]).index(), c = $(e[a]);
        b === a && (c.addClass("highlighted"), c.removeClass("on-highlight"));
    }), $(d).on("mouseleave", function() {
        e.removeClass("on-highlight").removeClass("highlighted");
    }), $(e).on("mouseover", function() {
        var a = $(this).index(), b = $(d[a]).index(), c = $(d[a]);
        b === a && c.find("a").addClass("active");
    ...
    $(document).ready(function() {
        ...
        $(".project-details-trigger").click(function() {
            $(".project-details-trigger i").toggleClass("icon-minus"), $(".gallery-container").toggleClass("display-project-details");
        }), a = $(".project-details-scroll"), b = $(".project-details-scroll-down"), c = 0, 
        b.click(function() {
            100 > c ? a.css({
                transform: "translateY(-" + (c += 25) + "%)",
                "transform-origin": "translateY(-" + (c += 25) + "%)",
                "webkit-transform": "translateY(-" + (c += 25) + "%)",
                "webkit-transform-origin": "translateY(-" + (c += 25) + "%)"
            }) : (c = 0, a.css({
